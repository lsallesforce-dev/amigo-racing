  ...
  payments: [
    {
      ...
      split: [
        {
          recipient_id: "re_cmltaagvolbp40l9tphxnq400", // Recipient do Lucas
        ...
        {
          recipient_id: "re_cmltaagvolbp40l9tphxnq400", // Recipient da plataforma (mesmo para teste)
...
console.log("📤 Enviando requisição ao Pagar.me...");
console.log("URL:", `${PAGARME_API_URL}/orders`);
